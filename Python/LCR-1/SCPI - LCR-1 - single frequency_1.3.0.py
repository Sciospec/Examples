...
with serial.Serial(port=COM_PORT, timeout=TIMEOUT, write_timeout=TIMEOUT,) as serial_connection:
    ...
    # Resetting the port configuration stack to prevent unwanted ports to be configured. This is important for the next
    # command
    ...
    print("Acknowledgement of the measurement channel reset command: " + serial_connection.readline().decode().strip())
    print("\n")

    # Setting the measurement configuration to a 4-point measurement by adding a four-point configuration to the empty
    # channel stack
    MEASUREMENT_CHANNEL_COMMAND = "FUNCTION:MEASUREMENT:CHANNEL:ADD 1,0,1,0,1,0,1,0\n"
    ...
    MODEL_TYPE_COMMAND = "FUNCTION:MEASUREMENT:TYPE 4\n"
    ...
    FREQUENCY_COMMAND = "FREQUENCY 1000\n"
