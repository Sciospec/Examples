...
This Python project presents an example script to configure and perform a measurement with a Sciospec LCR-3 using a USB virtual COM port. The recorded measurement data are printed into the console as well as in a ".csv"-file.
...
4-point measurement at the Main port, at int-1 int-2 int-3 int-4, as well as at int-5 int-6 int-7 int-8
